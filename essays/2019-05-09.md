...
<img class="ui tiny right spaced image" src="../images/tor.jpg">*A twitter text mining and visualization project using R for the 410 Data Mining course at Manhattan College. All associated R code and data can be found in the associated repository.* 
